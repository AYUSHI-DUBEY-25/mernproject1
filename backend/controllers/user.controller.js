...
export const signup = async (req, res) => {
    ...
    const userSchema = z.object({
        firstName: z.string().min(2, { message: "FirstName should be atleast 2 characters long" }),
        lastName: z.string().min(2, { message: "LastName should be atleast 2 characters long" }),
...
export const purchases = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ errors: "purchased courses not found" })
